...
namespace FootballMatchManager.Migrations
{
    ...
    [Migration("20230509122048_AddMessageEntityTypeColumn")]
    partial class AddMessageEntityTypeColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FootballMatchManager.DataBase.Models.Team", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PkId = 1,
                            CrtDate = new DateTime(2023, 5, 9, 15, 20, 48, 653, DateTimeKind.Local).AddTicks(9795),
