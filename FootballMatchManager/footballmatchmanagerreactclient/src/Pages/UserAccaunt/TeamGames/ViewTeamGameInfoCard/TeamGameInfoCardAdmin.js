...
import TeamGameAdminButtons from "./TeamGameAdminButtons";

export default function TeamGameCardAdmin() {
    ...
    function leavFromTeamGame() {
        axios.delete('http://localhost:5004/api/teamgame/leave-team-game/' + gameId + '/' + game.secondTeam.pkId, { withCredentials: true })
            .then((response) => {
                        ...
                        <div className="col-3 tg-info-text-container">
                            ...
                            <div className="row tg-button-cont">
                                <div className="col tg-button-cont-2">
                                    <TeamGameAdminButtons game={game}
