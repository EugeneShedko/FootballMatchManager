...
import { TO_GAMES, TO_MAIN, TO_NOTIFICATION, TO_PLAYERS, TO_TEAMS, TO_TEAM_GAMES } from "../Utilts/Consts";
import { Context } from "../index";

import "./../css/userprofile.css";

export default function AdminAccauntPage() {
                ...
                <Row className="m-0 p-0">
                    <Col sm={2} className="p-0">
                        <Nav className="flex-column upnav-container">
                            ...
                            <Nav.Item className="upnav-item">
                                <Nav.Link className="upnav-item-link" onClick={() => navigate(TO_PLAYERS, { state: { refresh: true } })}>Пользователи</Nav.Link>
                            </Nav.Item>
                            <Nav.Item className="upnav-item">
