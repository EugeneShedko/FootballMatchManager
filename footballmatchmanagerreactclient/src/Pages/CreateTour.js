...
export default function CreateTour(props) {
    ...
    function createTour() {
        ...
        axios.post('http://localhost:5004/api/profile/createtour', data, { withCredentials: true })
            .then((response) => {
            ...
            .then(() => {
                axios.get('http://localhost:5004/api/profile/allmatches', { withCredentials: true })
                    .then((response) => {
