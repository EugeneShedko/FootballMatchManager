...
import CreateMatch from "./Games/CreateGame";
import GameGenerator from "./Games/ViewGames/GameGenerator";
...
export default function Teams(props) {
    ...
    useEffect(
        () => {
            axios.get('http://localhost:5004/api/profile/allteams', { withCredentials: true })
                .then((response) => {
