...
export default function AdminGameInfoCard(props) {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:5004/api/admin/profile/match/' + props.gameId, { withCredentials: true })
            .then((response) => {
                setGame(response.data);
            })
            .then(() => {
                axios.get('http://localhost:5004/api/admin/profile/matchUsers/' + props.gameId, { withCredentials: true })
                    .then((response) => {
    ...
    function deleteMatch() {
        ...
        axios.delete('http://localhost:5004/api/admin/profile/deletegame/' + game.gameId, { withCredentials: true })
            .then((response) => {
    ...
    function blockMatch()
    {
        ...
        axios.post('http://localhost:5004/api/admin/profile/blockgame/', data, { withCredentials: true })
        .then((response) => {
    ...
    function unblockMatch()
    {
        ...
        axios.post('http://localhost:5004/api/admin/profile/unblockgame/', data, { withCredentials: true })
        .then((response) => {
            setGame(response.data.currgame);
            toast.success(response.data.message,
                {
