...
import "./../css/tournamentinfopage.css"
...
export default function TournamentInfoPage(props) {
    ...
    return (
        <div className="row justify-content-center tournament-info-main-container">
            <div className="col-7 tournament-info-container">
                <div className="row m-0 h-100">
                    <div className="col-6 tournament-info-text-container">
                        <div className="row tournament-info-title">
                            {props.info.info.matchName}
                        </div>
                        <div className="row tournament-info-header">
                            Время матча
                        </div>
                        <div className="row tournament-info-text">
